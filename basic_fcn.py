...
class FCN(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.deconv5 = nn.ConvTranspose2d(64, n_class, kernel_size=3, stride=2, padding=1, dilation=1, output_padding=1)
        self.bn5 = nn.BatchNorm2d(n_class)
        self.classifier = nn.Conv2d(n_class, self.n_class, kernel_size=1)
