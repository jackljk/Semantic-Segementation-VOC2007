...
def getClassWeights(dataset):
    ...
    Returns:
    torch.Tensor: The class weights for each class in the dataset.
    """
...
# Load the dataset
train_dataset =voc.VOC('train', common_transform=CommonTransforms())
...
fcn_model = SimplifiedUNet(n_class=n_class) # Create the model
...
# Save the best model
save_path = 'models/5a_best_model.pth'
